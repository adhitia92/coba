            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">DATA PEMINJAMAN BARANG MASUK</h3>
                        ...
                        <div class="box-body">
                            <div class="container">
                                <table id="datakategoribarang" class="table table-striped table-bordered"
                                    ...
                                    <tbody>
                                        @foreach ($data_penerima_peminjaman as $index => $penerima)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $penerima->peminjam->namapeminjam }}</td>
                                                <td>{{ $penerima->peminjam->kontak }}</td>
                                                <td>{{ $penerima->peminjam->instansi }}</td>
                                                <td>
                                                    @if ($penerima->peminjam->status == 'menunggu')
                                                        Menunggu Persetujuan
                                                    @else
                                                        {{ $penerima->peminjam->status }}
                                                    @endif
                                                </td>
                                                <td>
                                                    <a href="{{ route('peminjaman.approve', ['idpeminjam' => $penerima->peminjam->idpeminjam]) }}"
                                                        class="btn btn-success">Setuju</a>
                                                    <a href="{{ route('peminjaman.reject', ['idpeminjam' => $penerima->peminjam->idpeminjam]) }}"
                                                        class="btn btn-danger">Tolak</a>
                                                    <a href="{{ route('kepalalab.datapeminjaman.detail', ['idpeminjam' => $penerima->idpeminjam, 'idpeminjaman' => $penerima->idpeminjaman]) }}"
