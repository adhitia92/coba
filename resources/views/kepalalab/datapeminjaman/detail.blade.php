    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('datapeminjaman.kepalalab') }}" class="nav-link">Data Peminjaman Barang Masuk</a>
                </li>
            </ul>
                                    ...
                                    <tbody>
                                        @foreach ($data_penerima_peminjaman as $index => $penerima)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>
                                                    @if($penerima->barang->gambar)
                                                        <img src="{{ asset('storage/gambar_barang/' . basename($penerima->barang->gambar)) }}" alt="Foto Barang" style="max-width: 100px; max-height: 80px;">
                                                    @else
                                                ...
                                                <td>{{ $penerima->barang->kodebarcode }}  {{ $penerima->kategori->namakategori }} {{ $penerima->kategori->jenis }} {{ $penerima->kategori->merk }}</td>
                                                <td>
