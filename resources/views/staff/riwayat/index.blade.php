...
<body class="hold-transition sidebar-mini">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview {{ Request::is('Riwayatpeminjam*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('riwayatpeminjam.index') }}"
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="box-body">
                            <div class="container">
                                <table id="datariwayatpeminjam" class="table table-striped table-bordered"
                                    style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        @foreach ($data_riwayatpeminjam as $item)
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                <td>{{ $item->peminjam->namapeminjam }}
                                                    {{ $item->peminjam->instansi }}
                                                </td>
                                                <td>{{ $item->peminjam->kontak }} </td>
                                                <td>{{ $item->peminjam->keterangan }} </td>
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <button class="btn btn-danger" data-toggle="modal"
                                                            data-target="#modaldelete_{{ $item->idriwayatpeminjam }}">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </button>
                                                        <a href="{{ route('staff.riwayat.riwayatbarang', ['idpeminjam' => $item->idpeminjam]) }}" class="btn btn-info">
                                                            Detail
                                                        </a>
                                                    </div>
                                                </td>
    ...
    <!-- modal-->
    @foreach ($data_riwayatpeminjam as $item)
        <div class="modal fade" id="modaldelete_{{ $item->idriwayatpeminjam }}" tabindex="-1" role="dialog"
            aria-labelledby="modaldelete_{{ $item->idriwayatpeminjam }}Label" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modaldelete_{{ $item->idriwayatpeminjam }}Label">Konfirmasi
                            Penghapusan</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <form
                            action="{{ route('riwayatpeminjam.hapus', ['riwayatpeminjam' => $item->idriwayatpeminjam]) }}"
