                    ...
                    <div class="card-body">
                        ...
                        <div class="box-body">
                            <div class="container">
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        @if ($items->status == 'disetujui')
                                                            ...
                                                            @endphp
                                                            @if ($peminjaman)
                                                                <a href="{{ route('peminjaman.cetakpdf', ['idpeminjaman' => $peminjaman->idpeminjaman, 'idpeminjam' => optional($peminjaman->peminjam)->idpeminjam]) }}"
                                                                    class="btn btn-info">
                                                        ...
                                                        @if ($items->status == 'ditolak')
                                                            <form
                                                                action="{{ route('peminjam.hapus', ['peminjam' => $items->idpeminjam]) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
                                                        ...
                                                        @endif
                                                        <form method="get"
                                                            action="{{ route('peminjaman.index', ['idpeminjam' => $items->idpeminjam]) }}">
                                                        ...
                                                        <form method="post"
                                                            action="{{ route('peminjaman.selesai', ['idpeminjam' => $items->idpeminjam]) }}"
                                                            onsubmit="return confirm('Apakah Anda yakin ingin menyelesaikan peminjaman?')">
                                                            @csrf
                                ...
                                <a href="{{ route ('peminjamcetak.staff')}}" class="btn btn-primary">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post"
                                action="{{ route('peminjam.update', ['idpeminjam' => $item->idpeminjam]) }}"
                                novalidate>
                                @csrf
                                @method('PUT')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('peminjam.hapus', ['peminjam' => $item->idpeminjam]) }}"
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="myForm" action="{{ route('peminjam.post') }}" novalidate>
                        @csrf
